...
%Comparing Beyonce and Pitbull

filePaths = {'Beyonce - Sorry.wav', 'Beyonce - Single Ladies.wav', 'Beyonce - Pretty Hurts.wav', 'Beyonce - Love On Top.wav', 'Beyonce - If I Were A Boy.wav', 'Beyonce - Halo.wav', 'Beyonce - Formation.wav', 'Beyonce - Countdown.wav', 'Beyonce - Best Thing I Never Had.wav', 'Pitbull - Time Of Our Lives (Lyric) ft. Ne-Yo.wav', 'Pitbull - Timber.wav', 'Pitbull - On The Floor.wav', 'Pitbull - International Love .wav', 'Pitbull - I Like It Lyrics.wav', 'Pitbull - Hotel Room Service.wav', 'Pitbull - Give Me Everything.wav', 'Pitbull - Fireball.wav', 'Pitbull - Feel This Moment.wav'};
