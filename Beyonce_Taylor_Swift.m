...
filePaths = {'Beyonce - Sorry.wav', 'Beyonce - Single Ladies.wav', 'Beyonce - Pretty Hurts.wav', 'Beyonce - Love On Top.wav', 'Beyonce - If I Were A Boy.wav', 'Beyonce - Halo.wav', 'Beyonce - Formation.wav', 'Beyonce - Countdown.wav', 'Beyonce - Best Thing I Never Had.wav', 'Taylor Swift - You Belong With Me.wav', 'Taylor Swift - Wildest Dreams (Taylors Version) (Lyric Video).wav','Taylor Swift - Style (Taylors Version) (Lyric Video).wav','Taylor Swift - Shake It Off (Taylors Version) (Lyric Video).wav','Taylor Swift - Out Of The Woods (Taylors Version) (Lyric Video).wav','Taylor Swift - Love Story.wav','Taylor Swift - Blank Space (Taylors Version) (Lyric Video).wav','Taylor Swift - Bad Blood (Taylors Version) (Lyric Video).wav','Taylor Swift - Anti-Hero (Official Lyric Video).wav',};
